...
class FollowersChart extends Component {
	render() {
		console.log('[RENDER] FollowersChart - ./followers/followers_chart.js');
		...
		return (
			<div className="chart-wrapper">
				<VictoryChart style={{overflow: 'visible'}} width={1000} height={350} containerComponent={<VictoryVoronoiContainer/>} >
					<VictoryAxis
